    ...
    <div className="container">
      <div className="container-fluid p-10">
        ...
        <p style={{ color: "grey", fontSize: "12px" }}>
          ...
          Rental| Salons Courier Services |Dance classNames| Pathology Labs|
          ...
          Shops| Paediatricians |Sonography Centres | Yoga classNamees| Hostels
          Cardiologists| Electrical Shops| Skin Care Clinics | Diagnostic
          Centres| Homeopathic Doctors | Physiotherapists | Photo Studios |
          Plumbers |Music classNamees| Electricians| Sports |Goods Dealers| Shoe
