              ...
              <div className="offcanvas-body">
                ...
                <div className="row">
                  ...
                  <div className="col-lg-2">
                    <a href="/ac-repair">
                      <img src="./images/fafa icon/ac.png" width="20px" /> AC
                      Services
                    </a>
                  </div>
                  <div className="col-lg-2">
                    <a href="/software">
                      <img src="./images/fafa icon/software.png" width="20px" />{" "}
                      Software
                    </a>
                  </div>
                  <div className="col-lg-2">
                  ...
                  <div className="col-lg-2">
                    <a href="/Training">
                      <img src="./images/fafa icon/training.png" width="20px" />
                      Training
                    </a>
                  </div>
                  <div className="col-lg-2">
                ...
                <div className="row">
                  <div className="col-lg-2">
                    <a href="/Security">
                      <img src="./images/fafa icon/security.png" width="20px" />
                      Security
                    </a>
                  </div>
                  <div className="col-lg-2">
                    <a href="/flight">
                      <img src="./images/fafa icon/flight.png" width="20px" />
                      Travel
                    </a>
                  </div>
                  <div className="col-lg-2">
                    <a href="/Shoping">
                      <img src="./images/fafa icon/shopping.png" width="20px" />
                      Shopping
                    </a>
                  </div>
                  <div className="col-lg-2">
                  ...
                  <div className="col-lg-2">
                    <a href="/job">
                      <img src="./images/fafa icon/job.png" width="20px" />
                      Jobs
                    </a>
                  </div>
                  <div className="col-lg-2">
                    <a href="/incometax">
                      <img src="./images/fafa icon/legal.png" width="20px" />
                      Legal
                    </a>
                  </div>
                </div>
                ...
                <div className="row">
                  <div className="col-lg-2">
                    <a href="/hotelclient">
                      <img src="./images/fafa icon/pg.png" width="20px" />
                      Hotels
                    </a>
                  </div>
                  <div className="col-lg-2">
                  ...
                  <div className="col-lg-2">
                    <a href="/jewellary">
                      <img src="./images/fafa icon/jewelary.png" width="20px" />
                      Jewellary
                    </a>
                  </div>
                  <div className="col-lg-2">
                  ...
                  <div className="col-lg-2">
                    <a href="/internet">
                      <img src="./images/fafa icon/Internet.png" width="20px" />
                      Internet
                    </a>
                  </div>
                  <div className="col-lg-2">
                ...
                <div className="row">
                  <div className="col-lg-2">
                    <a href="/beautyparlour">
                      <img src="./images/fafa icon/slen.png" width="20px" />
                      Salon
                    </a>
                  </div>
                  <div className="col-lg-2">
                  ...
                  <div className="col-lg-2">
                    <a href="/account">
                      <img src="./images/fafa icon/account.png" width="20px" />
                      Account
                    </a>
                  </div>
                  <div className="col-lg-2">
                  ...
                  <div className="col-lg-2">
                    <a href="/Tatto">
                      <img src="./images/fafa icon/tattoo.png" width="20px" />
                      tattoo
                    </a>
                  </div>
                </div>
                ...
                <div className="row">
                  <div className="col-lg-2">
                    <a href="Store">
                      <img src="./images/fafa icon/store.png" width="20px" />
                      Store
                    </a>
                  </div>
                  <div className="col-lg-2">
                  ...
                  <div className="col-lg-2">
                    <a href="/gym">
                      <img src="./images/fafa icon/Gym.png" width="20px" />
                      Fitness
                    </a>
                  </div>
                  <div className="col-lg-2">
                ...
                <div className="row">
                  ...
                  <div className="col-lg-2">
                    <a href="/hospital">
                      <img src="./images/fafa icon/hosp.png" width="20px" />
                      Hospitals
                    </a>
                  </div>
                  <div className="col-lg-2">
                  ...
                  <div className="col-lg-2">
                    <a href="/petshops">
                      <img src="./images/fafa icon/pethouse.png" width="20px" />
                      Pet Shops
                    </a>
                  </div>
                  <div className="col-lg-2">
                  ...
                  <div className="col-lg-2">
                    <a href="/dentist">
                      <img src="./images/fafa icon/Dentists.png" width="20px" />
                      Dentists
                    </a>
                  </div>
                </div>
